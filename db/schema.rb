...
ActiveRecord::Schema.define(version: 20150417185434) do
  ...
  add_index "deals", ["email"], name: "index_deals_on_email", unique: true, using: :btree
  add_index "deals", ["reset_password_token"], name: "index_deals_on_reset_password_token", unique: true, using: :btree
